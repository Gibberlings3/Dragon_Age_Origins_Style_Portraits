...
set "mod_name=Dragon Age Origins Portraits"
set mod_version=v8
set mod_folder=da_portraits
...
set mod_readme=http://htmlpreview.github.io/?https://github.com/Gibberlings3/Documentation/blob/master/readme-%mod_folder%.html
